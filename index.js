...
<head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Syria Commerce — تجارتك تبدأ من جمهورك</title>
<style>
:root{--green:#13bd79;--dark:#061b19;--dark2:#0b2926;--cream:#f7f7f2;--ink:#102522;--muted:#687873;--line:#dfe8e3}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--cream);color:var(--ink);font-family:Arial,Tahoma,sans-serif}a{text-decoration:none;color:inherit}.wrap{max-width:1280px;margin:auto;padding:0 28px}
.nav{height:78px;background:var(--cream);border-bottom:1px solid #dce5e0;display:flex;align-items:center}.navIn{width:100%;display:flex;align-items:center;gap:38px}.brand{font-size:21px;font-weight:950;display:flex;align-items:center;gap:10px}.mark{width:39px;height:39px;background:var(--dark);color:#fff;border-radius:10px;display:grid;place-items:center;font-size:12px}.brand small{display:block;font-size:7px;letter-spacing:2px;color:#71807b;margin-top:2px}.links{display:flex;gap:23px;flex:1}.links a{font-size:12px;font-weight:800;color:#40504c}.links a:hover,.links a.active{color:#07915e}.actions{display:flex;gap:8px}.btn{display:inline-flex;align-items:center;justify-content:center;border-radius:9px;padding:12px 18px;font-size:12px;font-weight:900}.green{background:var(--green);color:#03251d}.white{background:transparent;border:1px solid #b9c9c3}
.hero{background:var(--dark);color:#fff}.heroIn{min-height:680px;display:grid;grid-template-columns:1fr 1fr;align-items:center}.heroCopy{padding:75px 0}.eyebrow{font-size:10px;color:#8ce3bd;font-weight:900;letter-spacing:.5px}.hero h1{font-size:76px;line-height:.99;letter-spacing:-4px;margin:22px 0 25px;font-weight:950}.hero h1 em{font-style:normal;color:var(--green)}.hero p{font-size:17px;line-height:1.9;color:#b6cbc5;max-width:610px;margin:0 0 29px}.heroBtns{display:flex;gap:9px}.heroBtns .white{color:#fff;border-color:#ffffff38}.notes{margin-top:20px;color:#809d96;font-size:9px}.notes span+span{margin-right:18px}.notes span:before{content:"—";color:var(--green);margin-left:5px}
.heroVisual{height:570px;display:flex;align-items:center;justify-content:center;position:relative}.screen{width:535px;position:relative}.screenTop{display:flex;justify-content:space-between;align-items:center;color:#91aaa3;font-size:9px;margin-bottom:13px}.screenTop strong{color:#fff;font-size:12px}.numbers{display:flex;align-items:end;gap:35px;border-bottom:1px solid #24433e;padding-bottom:21px}.numbers b{font-size:42px;letter-spacing:-2px;color:#fff}.numbers small{display:block;color:#73908a;font-size:9px;margin-bottom:6px}.rise{color:#38d995;font-size:9px;font-weight:900}.chart{height:220px;border-bottom:1px solid #294740;position:relative;margin-top:20px}.chart svg{width:100%;height:100%}.axis{display:flex;justify-content:space-between;color:#56736c;font-size:8px;margin-top:8px}.side{position:absolute;background:#fff;color:var(--ink);padding:13px 16px;top:80px;right:-32px;border-radius:8px;box-shadow:0 18px 35px #0005}.side small{display:block;color:#6c7c77;font-size:8px}.side strong{font-size:15px;display:block;margin-top:4px;color:#078f60}
.band{background:#fff;border-bottom:1px solid var(--line)}.bandIn{display:grid;grid-template-columns:repeat(4,1fr)}.stat{padding:26px 18px;border-left:1px solid var(--line);text-align:center}.stat:last-child{border-left:0}.stat b{font-size:23px}.stat span{display:block;color:var(--muted);font-size:9px;margin-top:5px}
.section{padding:82px 0}.sectionHead{display:flex;align-items:end;justify-content:space-between;margin-bottom:35px}.sectionHead h2{font-size:37px;letter-spacing:-1.5px;margin:0}.sectionHead p{color:var(--muted);font-size:12px;margin:6px 0 0}.sectionHead a{font-size:11px;color:#078f60;font-weight:900}
.products{display:grid;grid-template-columns:repeat(4,1fr);gap:25px}.product{background:transparent}.photo{height:315px;background:#e9eeeb;display:grid;place-items:center;font-size:72px;position:relative;overflow:hidden}.photo:after{content:"";position:absolute;inset:auto 0 0;height:35%;background:linear-gradient(transparent,#00000008)}.badge{position:absolute;top:13px;right:13px;background:#fff;padding:7px 9px;font-size:8px;font-weight:900;z-index:2}.product h3{font-size:14px;margin:13px 2px 6px}.meta{display:flex;justify-content:space-between;align-items:center;font-size:9px;color:var(--muted)}.profit{color:#078f60;font-weight:950}.product .line{height:1px;background:#dce5e1;margin-top:13px}
.split{background:var(--dark);color:#fff}.splitIn{display:grid;grid-template-columns:1fr 1fr;gap:100px;align-items:center}.split h2{font-size:46px;letter-spacing:-2px;line-height:1.05;margin:0 0 18px}.split p{color:#a9c2bb;font-size:13px;line-height:1.9;max-width:520px}.manifesto{border-top:1px solid #24423e;margin-top:30px;padding-top:20px;display:grid;grid-template-columns:1fr 1fr;gap:20px}.manifesto div b{font-size:13px;display:block}.manifesto div span{font-size:9px;color:#78968e;display:block;margin-top:5px}.tools{border-right:1px solid #24423e;padding-right:55px}.toolRow{display:flex;align-items:center;gap:18px;padding:18px 0;border-bottom:1px solid #24423e}.toolRow:last-child{border:0}.toolNo{font-size:10px;color:#42d99e;width:24px}.toolRow b{font-size:14px}.toolRow span{display:block;color:#76958d;font-size:9px;margin-top:4px}
.steps{display:grid;grid-template-columns:repeat(3,1fr);gap:50px}.step{border-top:2px solid var(--green);padding-top:18px}.step .n{font-size:10px;color:#078f60;font-weight:900}.step h3{font-size:18px;margin:13px 0 7px}.step p{font-size:11px;color:var(--muted);line-height:1.8;margin:0}
.quote{padding:92px 0;background:#e9f1ed}.quoteIn{max-width:880px;text-align:center;margin:auto}.quote p{font-size:36px;line-height:1.35;letter-spacing:-1.2px;font-weight:900;margin:0}.quote strong{color:#078f60}.quote span{display:block;margin-top:18px;font-size:9px;color:#6b7b76}
.cta{background:var(--green);color:#03251d;padding:52px 58px;display:flex;align-items:center;justify-content:space-between;gap:25px}.cta h2{font-size:37px;letter-spacing:-1.5px;margin:0 0 7px}.cta p{font-size:12px;margin:0}.cta .darkBtn{background:var(--dark);color:#fff;padding:14px 22px;border-radius:9px;font-size:12px;font-weight:900;white-space:nowrap}
footer{background:#fff;padding:30px 0;border-top:1px solid var(--line)}.foot{display:flex;justify-content:space-between;color:#71807c;font-size:9px}.footLinks{display:flex;gap:20px}.footLinks a:hover{color:#078f60}
@media(max-width:950px){.links{display:none}.heroIn,.splitIn{grid-template-columns:1fr}.heroVisual{height:480px}.products{grid-template-columns:repeat(2,1fr)}.bandIn{grid-template-columns:repeat(2,1fr)}.stat{border-bottom:1px solid var(--line)}.tools{border-right:0;padding-right:0}.steps{grid-template-columns:1fr;gap:28px}}
@media(max-width:600px){.nav{height:68px}.navIn{justify-content:space-between}.actions .white{display:none}.hero h1{font-size:47px;letter-spacing:-2px}.heroCopy{padding:50px 0 15px}.hero p{font-size:15px}.heroVisual{height:390px}.screen{width:100%}.numbers b{font-size:30px}.side{right:-3px;top:58px}.chart{height:160px}.section{padding:55px 0}.sectionHead{display:block}.sectionHead h2{font-size:29px}.sectionHead a{display:inline-block;margin-top:12px}.products{grid-template-columns:1fr 1fr;gap:18px}.photo{height:190px;font-size:48px}.product h3{font-size:12px}.meta{font-size:8px}.split h2{font-size:34px}.splitIn{gap:45px}.quote p{font-size:25px}.cta{padding:34px 25px;display:block}.cta h2{font-size:29px}.cta .darkBtn{display:inline-block;margin-top:22px}.foot{display:block}.footLinks{margin-top:14px;flex-wrap:wrap}}
</style>
</head>
<body>
...
<nav class="links"><a class="active" href="/">الرئيسية</a><a href="/products">المنتجات</a><a href="/marketer">كيف تربح؟</a><a href="/marketer">أدوات التسويق</a><a href="/login">حسابي</a></nav>
<div class="actions"><a class="btn white" href="/login">دخول</a><a class="btn green" href="/register">ابدأ الآن</a></div>
</div></header>

<main>
<section class="hero"><div class="wrap heroIn">
<div class="heroCopy"><div class="eyebrow">SYRIA COMMERCE / FOR MARKETERS</div>
<h1>لا تحتاج متجر.<br>تحتاج <em>جمهور.</em></h1>
<p>اختر المنتج المناسب، وصّل المنتج بجمهورك، وخلي المنصة تتولى رحلة الطلب. أنت تركز على البيع — ونحن نبني لك الأدوات حوله.</p>
<div class="heroBtns"><a class="btn green" href="/register">ابدأ كمسوّق مجاناً ↗</a><a class="btn white" href="/products">تصفح المنتجات</a></div>
<div class="notes"><span>بدون مخزون</span><span>أدوات تسويق جاهزة</span><span>تتبع واضح للأرباح</span></div></div>
<div class="heroVisual"><div class="screen">
<div class="screenTop"><strong>أداء حساب المسوّق</strong><span>آخر 30 يوم</span></div>
<div class="numbers"><div><small>الأرباح</small><b>1.84M</b><div class="rise">+28.4% هذا الشهر</div></div><div><small>الطلبات</small><b>86</b></div><div><small>المبيعات</small><b>12.4M</b></div></div>
<div class="chart"><svg viewBox="0 0 600 220" preserveAspectRatio="none"><path d="M0 190 L70 175 L130 184 L195 125 L255 143 L325 92 L390 110 L465 58 L535 72 L600 20 L600 220 L0 220Z" fill="#13bd7915"/><polyline points="0,190 70,175 130,184 195,125 255,143 325,92 390,110 465,58 535,72 600,20" fill="none" stroke="#13bd79" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
<div class="axis"><span>1 أغسطس</span><span>10</span><span>20</span><span>28 أغسطس</span></div>
<div class="side"><small>متوسط الربح / طلب</small><strong>+21,400 SYP</strong></div>
</div></div></div></section>

<section class="band"><div class="wrap bandIn"><div class="stat"><b>+1,200</b><span>مسوّق مسجل</span></div><div class="stat"><b>+8,500</b><span>طلب تم تسجيله</span></div><div class="stat"><b>+320</b><span>منتج متاح</span></div><div class="stat"><b>24/7</b><span>منصة تعمل معك</span></div></div></section>

<section class="section"><div class="wrap"><div class="sectionHead"><div><h2>المنتجات التي تستحق وقتك.</h2><p>اختيارات جاهزة للتسويق، مع هامش الربح أمامك.</p></div><a href="/products">مشاهدة كل المنتجات ←</a></div>
<div class="products">
<article class="product"><div class="photo"><span class="badge">الأكثر طلباً</span>🎧</div><h3>سماعة بلوتوث لاسلكية</h3><div class="meta"><span>هامش ربح قوي</span><span class="profit">+45,000 SYP</span></div><div class="line"></div></article>
<article class="product"><div class="photo"><span class="badge">هامش مرتفع</span>⌚</div><h3>ساعة رجالية فاخرة</h3><div class="meta"><span>مناسبة للإعلانات</span><span class="profit">+80,000 SYP</span></div><div class="line"></div></article>
<article class="product"><div class="photo"><span class="badge">اختيار المسوّقين</span>🧴</div><h3>عطر رجالي أصلي</h3><div class="meta"><span>طلب متكرر</span><span class="profit">+65,000 SYP</span></div><div class="line"></div></article>
<article class="product"><div class="photo"><span class="badge">جديد</span>🎒</div><h3>حقيبة متعددة الاستخدام</h3><div class="meta"><span>جمهور واسع</span><span class="profit">+38,000 SYP</span></div><div class="line"></div></article>
</div></div></section>

<section class="section split"><div class="wrap splitIn"><div><div class="eyebrow">YOUR SELLING TOOLKIT</div><h2>أنت تعرف جمهورك.<br>نحن نعطيك <span style="color:#13bd79">الأدوات.</span></h2><p>بدل ما تبني متجر وتشتري مخزون وتتابع عشرات الأنظمة، افتح حساب المسوّق وخذ ما تحتاجه لتبدأ البيع.</p><div class="manifesto"><div><b>اختيار المنتج</b><span>سعر + ربح + معلومات واضحة</span></div><div><b>تتبع الطلب</b><span>اعرف حالة كل عملية بيع</span></div></div></div>
<div class="tools"><div class="toolRow"><div class="toolNo">01</div><div><b>روابط تتبع</b><span>كل مشاركة قابلة للقياس</span></div></div><div class="toolRow"><div class="toolNo">02</div><div><b>محتوى المنتج</b><span>صور ومعلومات جاهزة للنشر</span></div></div><div class="toolRow"><div class="toolNo">03</div><div><b>لوحة أرباح</b><span>نتائجك في مكان واحد</span></div></div><div class="toolRow"><div class="toolNo">04</div><div><b>إدارة الطلبات</b><span>من أول طلب حتى إتمامه</span></div></div></div></div></section>

<section class="section"><div class="wrap"><div class="sectionHead"><div><h2>من جمهورك إلى أول ربح.</h2><p>الطريقة أبسط مما تتخيل.</p></div></div><div class="steps"><div class="step"><span class="n">01 / اختر</span><h3>اختر منتجاً</h3><p>شاهد المنتجات المتاحة، السعر، وهامش الربح قبل أن تبدأ.</p></div><div class="step"><span class="n">02 / سوّق</span><h3>وصلّه لجمهورك</h3><p>شارك الرابط والمحتوى عبر القنوات التي تعرف أنها تعمل مع جمهورك.</p></div><div class="step"><span class="n">03 / اربح</span><h3>تابع كل عملية</h3><p>الطلبات والأداء والأرباح تظهر لك داخل حسابك بوضوح.</p></div></div></div></section>

<section class="quote"><div class="wrap quoteIn"><p>“Syria Commerce ليست مكاناً تشتري منه.<br>هي المكان الذي <strong>تبدأ منه تجارتك.</strong>”</p><span>مصممة للمسوّقين، من أول نقرة إلى أول ربح.</span></div></section>

<section class="section" style="padding-bottom:60px"><div class="wrap"><div class="cta"><div><h2>خلّي جمهورك يشتغل معك.</h2><p>ابدأ مجاناً واختر أول منتج اليوم.</p></div><a class="darkBtn" href="/register">إنشاء حساب مسوّق ↗</a></div></div></section>
</main>

<footer><div class="wrap foot"><div>© 2026 Syria Commerce — Commerce for Marketers</div><div class="footLinks"><a href="/products">المنتجات</a><a href="/marketer">كيف تربح؟</a><a href="/login">دخول</a><a href="/register">التسجيل</a></div></div></footer>
