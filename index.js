...
<style>
:root{--red:#ff3b30;--red-dark:#d92b23;--ink:#171311;--paper:#f8f3ed;--warm:#eee5dc;--line:#ddd3c9;--muted:#746b65;--white:#fff}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--paper);color:var(--ink);font-family:"Noto Sans Arabic","IBM Plex Sans Arabic",Tahoma,Arial,sans-serif;-webkit-font-smoothing:antialiased}a{text-decoration:none;color:inherit}.wrap{max-width:1180px;margin:auto;padding:0 26px}
.top{height:82px;background:var(--paper);color:var(--ink);position:sticky;top:0;z-index:100;border-bottom:1px solid var(--line)}.nav{height:100%;display:flex;align-items:center;justify-content:space-between;gap:28px}.logo{display:flex;align-items:center;gap:11px;font-weight:950;font-size:18px;letter-spacing:-.5px}.logoMark{width:42px;height:42px;border-radius:13px;background:var(--ink);color:#fff;display:grid;place-items:center;font-size:11px}.links{display:flex;gap:2px;flex:1;justify-content:center}.links a{font-size:11px;font-weight:850;padding:11px 14px;border-radius:10px;color:var(--ink);opacity:.76}.links a:hover{background:var(--warm);opacity:1}.navBtns{display:flex;gap:8px}.btn{display:inline-flex;align-items:center;justify-content:center;border-radius:11px;padding:12px 18px;font-size:11px;font-weight:950;border:1px solid transparent;cursor:pointer}.btn.white{background:#fff;color:var(--ink);border-color:var(--line)}.btn.dark{background:var(--ink);color:#fff}.btn.red{background:var(--red);color:#fff;box-shadow:0 9px 22px #ff3b3028}.btn.out{background:transparent;color:var(--ink);border-color:var(--line)}
.hero{background:var(--paper);border-bottom:1px solid var(--line)}.heroIn{min-height:650px;display:grid;grid-template-columns:1.03fr .97fr;align-items:center;gap:64px}.copy{padding:70px 0}.kicker{display:inline-flex;align-items:center;gap:9px;font-size:10px;font-weight:950;color:var(--red-dark);margin-bottom:20px}.kicker i{display:block;width:28px;height:3px;background:var(--red);border-radius:4px}h1{font-size:76px;line-height:1.01;letter-spacing:-4.4px;margin:0 0 22px;font-weight:950}h1 em{font-style:normal;color:var(--red)}.copy p{font-size:15px;line-height:2;color:var(--muted);max-width:560px;margin:0 0 27px}.actions{display:flex;gap:9px;flex-wrap:wrap}.proof{display:flex;gap:20px;flex-wrap:wrap;margin-top:22px;font-size:9px;font-weight:850;color:#615952}.proof span:before{content:"✓";color:var(--red);font-weight:950;margin-left:5px}
.visual{height:535px;position:relative;display:grid;place-items:center}.visual:before{content:"";position:absolute;width:455px;height:455px;border-radius:50%;background:var(--warm);top:34px;right:5px}.panel{position:relative;width:432px;background:#fff;border:1px solid var(--line);border-radius:28px;padding:23px;box-shadow:0 26px 70px #17131118}.panelTop{display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid var(--line);padding-bottom:14px}.miniBrand{display:flex;align-items:center;gap:8px;font-size:10px;font-weight:950}.miniMark{width:30px;height:30px;border-radius:9px;background:var(--ink);color:#fff;display:grid;place-items:center;font-size:8px}.panelTop small{font-size:8px;color:#91877f}.panel h2{font-size:27px;line-height:1.2;margin:22px 0 7px;letter-spacing:-1px}.panel h2 span{color:var(--red)}.panelSub{font-size:9px;color:var(--muted);line-height:1.9;margin-bottom:18px}.stats{display:grid;grid-template-columns:1.25fr .75fr;gap:9px}.stat{border:1px solid var(--line);border-radius:15px;padding:15px}.stat.hot{background:var(--red);border-color:var(--red);color:#fff}.stat small{display:block;font-size:8px;opacity:.72;margin-bottom:8px}.stat b{font-size:20px;letter-spacing:-.5px}.list{margin-top:10px;border-top:1px solid var(--line)}.row{display:flex;justify-content:space-between;padding:12px 2px;font-size:9px;border-bottom:1px solid #eee9e3}.row b{color:var(--red-dark)}.bubble{position:absolute;z-index:2;background:var(--ink);color:#fff;border-radius:14px;padding:12px 15px;left:-23px;top:83px;font-size:9px;font-weight:900;box-shadow:0 14px 28px #17131120}.bubble b{display:block;font-size:15px;margin-top:2px}.seal{position:absolute;right:0;bottom:27px;width:96px;height:96px;border-radius:50%;background:var(--red);color:#fff;display:grid;place-items:center;text-align:center;font-size:9px;font-weight:950;line-height:1.35;box-shadow:0 15px 35px #ff3b3030;transform:rotate(-8deg)}
.section{padding:90px 0}.white{background:#fff}.head{text-align:center;margin-bottom:38px}.label{font-size:9px;color:var(--red-dark);font-weight:950;letter-spacing:.2px}.head h2{font-size:38px;letter-spacing:-1.6px;margin:8px 0 6px}.head p{font-size:11px;color:var(--muted);margin:0;line-height:1.9}
.steps{display:grid;grid-template-columns:repeat(4,1fr);border-top:1px solid var(--ink);border-bottom:1px solid var(--ink)}.step{padding:29px 22px;min-height:200px;border-left:1px solid var(--line);position:relative}.step:last-child{border-left:0}.num{font-size:10px;color:var(--red-dark);font-weight:950}.step h3{font-size:19px;margin:34px 0 7px;letter-spacing:-.4px}.step p{font-size:10px;line-height:1.9;color:var(--muted);margin:0;max-width:180px}.line{width:28px;height:3px;background:var(--red);margin-top:19px;border-radius:3px}
.split{display:grid;grid-template-columns:.92fr 1.08fr;gap:18px;align-items:stretch}.redBlock{background:var(--red);color:#fff;border-radius:26px;padding:40px;min-height:405px;display:flex;flex-direction:column;justify-content:space-between;position:relative;overflow:hidden}.redBlock:after{content:"";position:absolute;width:220px;height:220px;border:1px solid #fff5;border-radius:50%;left:-70px;bottom:-75px}.redBlock h2{font-size:37px;line-height:1.18;margin:0;letter-spacing:-1.3px;position:relative;z-index:1}.redBlock p{font-size:11px;line-height:2;color:#fff0ed;max-width:390px;position:relative;z-index:1}.redBlock .big{font-size:64px;line-height:1;font-weight:950;letter-spacing:-3.5px;position:relative;z-index:1}.redBlock .big small{display:block;font-size:9px;letter-spacing:0;font-weight:800;margin-top:8px}.toolGrid{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:var(--line);border:1px solid var(--line);border-radius:26px;overflow:hidden}.tool{background:#fff;padding:31px;min-height:202px}.toolNo{font-size:9px;color:var(--red-dark);font-weight:950}.tool h3{font-size:18px;margin:26px 0 7px;letter-spacing:-.3px}.tool p{font-size:10px;color:var(--muted);line-height:1.9;margin:0}
.products{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.product{border:1px solid var(--line);border-radius:20px;overflow:hidden;background:#fff;transition:transform .2s ease,box-shadow .2s ease}.product:hover{transform:translateY(-3px);box-shadow:0 15px 35px #17131110}.productVisual{height:164px;background:var(--warm);display:grid;place-items:center;position:relative;overflow:hidden}.productVisual:before{content:"";position:absolute;width:110px;height:110px;border-radius:30px;background:var(--red);transform:rotate(12deg)}.productVisual:after{content:"";position:absolute;width:52px;height:52px;border-radius:50%;background:var(--ink);opacity:.95}.productVisual span{position:absolute;z-index:2;color:#fff;font-size:22px;font-weight:950}.productBody{padding:16px}.tag{font-size:8px;font-weight:950;color:var(--red-dark);background:#fff0ed;padding:5px 7px;border-radius:7px}.product h3{font-size:13px;margin:11px 0 5px}.product p{font-size:9px;line-height:1.7;color:var(--muted);margin:0 0 13px}.price{display:flex;justify-content:space-between;align-items:end;border-top:1px solid var(--line);padding-top:11px}.price small{font-size:8px;color:var(--muted)}.price b{display:block;font-size:12px;margin-top:2px}.price .btn{padding:9px 11px;font-size:9px}
.statement{background:var(--ink);color:#fff;padding:84px 0}.statementIn{display:grid;grid-template-columns:1fr 1fr;gap:70px;align-items:center}.statement h2{font-size:48px;line-height:1.08;letter-spacing:-2px;margin:0}.statement h2 em{font-style:normal;color:var(--red)}.statement p{font-size:12px;line-height:2;color:#bfb5ad;margin:0 0 23px}.statement ul{list-style:none;padding:0;margin:0;display:grid;gap:11px}.statement li{font-size:10px;border-bottom:1px solid #ffffff16;padding-bottom:11px}.statement li b{color:#fff}.statement li:before{content:"—";color:var(--red);margin-left:7px}.cta{padding:78px 0}.ctaBox{background:var(--red);color:#fff;border-radius:27px;padding:46px 49px;display:flex;align-items:center;justify-content:space-between;gap:20px;box-shadow:0 20px 50px #ff3b3020}.ctaBox h2{font-size:35px;margin:0 0 6px;letter-spacing:-1px}.ctaBox p{font-size:10px;color:#fff0ed;margin:0}.footer{background:#111;color:#aaa;padding:29px 0;font-size:9px}.foot{display:flex;justify-content:space-between;gap:15px}.footLinks{display:flex;gap:18px}.footLinks a:hover{color:#fff}
@media(max-width:950px){.links{display:none}.heroIn,.statementIn,.split{grid-template-columns:1fr}.copy{padding:60px 0 15px}.visual{height:500px}.steps,.products{grid-template-columns:1fr 1fr}.step:nth-child(2){border-left:0}.redBlock{min-height:330px}}
@media(max-width:600px){.top{height:68px}.logo{font-size:16px}.navBtns .out{display:none}.wrap{padding:0 18px}h1{font-size:47px;letter-spacing:-2.6px}.copy p{font-size:13px}.visual{height:410px}.visual:before{width:295px;height:295px;right:0;top:50px}.panel{width:94%;padding:16px;border-radius:21px}.panel h2{font-size:22px}.bubble{left:-3px;top:45px}.seal{width:72px;height:72px;right:0;bottom:23px;font-size:7px}.section{padding:62px 0}.head h2{font-size:30px}.steps,.products{grid-template-columns:1fr}.step{border-left:0;border-bottom:1px solid var(--line);min-height:auto;padding:24px}.step:last-child{border-bottom:0}.toolGrid{grid-template-columns:1fr}.tool{min-height:auto}.redBlock{padding:29px;border-radius:22px}.redBlock h2{font-size:30px}.redBlock .big{font-size:48px}.statement h2{font-size:36px}.statementIn{gap:31px}.ctaBox{display:block;padding:32px 26px}.ctaBox h2{font-size:29px}.ctaBox .btn{margin-top:18px}.foot{display:block}.footLinks{margin-top:13px;flex-wrap:wrap}}
</style></style></head><body>
<header class="top"><div class="wrap nav"><a class="logo" href="/"><span class="logoMark">SC</span><span>Syria Commerce</span></a><nav class="links"><a href="/">الرئيسية</a><a href="/products">المنتجات</a><a href="/marketer">كيف تعمل</a><a href="/marketer">أدوات المسوّق</a><a href="/login">حسابي</a></nav><div class="navBtns"><a class="btn out" href="/login">دخول</a><a class="btn dark" href="/register">ابدأ الآن</a></div></div></header>
<main>
<section class="hero"><div class="wrap heroIn"><div class="copy"><div class="kicker"><i></i> منصة البيع للمسوّقين</div><h1>بيع بذكاء.<br><em>واربح بثقة.</em></h1><p>كل ما تحتاجه لتختار المنتج، تسوّقه، تتابع الطلب وتحسب عمولتك — في تجربة واحدة مرتبة وواضحة.</p><div class="actions"><a class="btn red" href="/register">ابدأ كمسوّق مجاناً ↗</a><a class="btn out" href="/products">استكشف المنتجات</a></div><div class="proof"><span>بدون مخزون</span><span>تتبع واضح</span><span>عمولات معروفة</span></div></div><div class="visual"><div class="panel"><div class="panelTop"><div class="miniBrand"><span class="miniMark">SC</span><span>مساحة المسوّق</span></div><small>محدّث الآن</small></div><h2>شغلك كله <span>واضح.</span></h2><div class="panelSub">المنتجات والطلبات والأرباح التي تهمك، مرتبة في مكان واحد.</div><div class="stats"><div class="stat hot"><small>الأرباح الحالية</small><b>1,840,000</b><small>SYP</small></div><div class="stat"><small>الطلبات</small><b>86</b><small>طلب</small></div></div><div class="list"><div class="row"><span>سماعة بلوتوث · طلب جديد</span><b>+45,000</b></div><div class="row"><span>ساعة رجالية · تم التأكيد</span><b>+80,000</b></div><div class="row"><span>عطر رجالي · قيد المتابعة</span><b>+65,000</b></div></div></div><div class="bubble">عمولتك<br><b>واضحة دائماً</b></div><div class="seal">SELL<br>TRACK<br>EARN</div></div></div></section>
...
</main><footer class="footer"><div class="wrap foot"><div>© 2026 Syria Commerce</div><div class="footLinks"><a href="/products">المنتجات</a><a href="/login">تسجيل الدخول</a><a href="/register">التسجيل</a></div></div></footer>`,"Syria Commerce | منصة المسوّقين");
    }
