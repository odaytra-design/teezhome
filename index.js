...
<head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Syria Commerce | منصتك للتسويق والبيع</title>
<style>
:root{--g:#08a66d;--g2:#087b55;--deep:#042e2c;--deep2:#061a22;--mint:#eaf9f2;--ink:#102321;--muted:#687875;--line:#e3ebe8;--bg:#f7faf8;--card:#fff;--gold:#f2b84b}
*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);font-family:Arial,Tahoma,sans-serif}a{text-decoration:none;color:inherit}.wrap{max-width:1240px;margin:auto;padding:0 20px}
.top{background:#032b2a;color:#d5e9e5;font-size:12px}.topIn{height:38px;display:flex;justify-content:space-between;align-items:center}.topIn div{display:flex;gap:18px}
.nav{background:#fff;border-bottom:1px solid var(--line);position:sticky;top:0;z-index:40}.navIn{height:76px;display:flex;align-items:center;gap:30px}.brand{display:flex;align-items:center;gap:9px;font-size:23px;font-weight:900;white-space:nowrap}.mark{width:41px;height:41px;border-radius:12px;background:var(--g);color:#fff;display:flex;align-items:center;justify-content:center;font-size:16px}.brand small{display:block;color:#788783;font-size:8px;letter-spacing:2px;margin-top:2px}.links{display:flex;gap:2px;flex:1}.links a{padding:11px 12px;border-radius:10px;color:#3e4c49;font-weight:700}.links a:hover,.links a.active{color:var(--g2);background:#effaf5}.actions{display:flex;gap:8px}.btn{display:inline-flex;align-items:center;justify-content:center;border:0;border-radius:11px;padding:12px 18px;font-weight:900;cursor:pointer}.g{background:var(--g);color:#fff}.d{background:#062f2c;color:#fff}.l{background:#edf3f1;color:#17312d}
.hero{background:linear-gradient(115deg,var(--deep2),var(--deep) 55%,#0a6b55);color:#fff}.heroIn{min-height:555px;display:grid;grid-template-columns:1.04fr .96fr;gap:35px;align-items:center}.copy{padding:48px 0}.eyebrow{display:inline-flex;background:#075548;border:1px solid #16886d;color:#c9f5e6;padding:8px 12px;border-radius:999px;font-size:12px;font-weight:900}.copy h1{font-size:56px;line-height:1.08;letter-spacing:-2px;margin:18px 0 14px}.copy h1 strong{color:#1bd18d}.copy p{font-size:18px;line-height:1.9;color:#c6dad6;max-width:650px;margin:0 0 23px}.heroBtns{display:flex;gap:9px;flex-wrap:wrap}.heroBtns .l{background:#fff;color:#06352f}.micro{display:flex;gap:18px;flex-wrap:wrap;margin-top:15px;color:#b8d4cf;font-size:11px}.micro span:before{content:"✓";color:#21d894;font-weight:900;margin-left:5px}
.dashboard{position:relative;min-height:460px;display:flex;align-items:center;justify-content:center}.dashCard{width:470px;background:#fff;border-radius:20px;padding:16px;box-shadow:0 28px 65px #0006;color:var(--ink);transform:rotate(1deg);z-index:2}.dashHead{display:flex;align-items:center;justify-content:space-between;padding:4px 3px 14px;border-bottom:1px solid var(--line)}.dashHead b{font-size:15px}.profile{display:flex;align-items:center;gap:7px}.avatar{width:30px;height:30px;border-radius:50%;background:#dff4eb;color:var(--g2);display:flex;align-items:center;justify-content:center;font-weight:900;font-size:10px}.stats{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;margin:12px 0}.stat{background:#f4f8f6;border-radius:11px;padding:12px}.stat small{display:block;color:var(--muted);font-size:9px;margin-bottom:5px}.stat b{font-size:17px}.greenText{color:var(--g2)}.chart{height:125px;background:#f7faf8;border-radius:11px;padding:12px;position:relative;overflow:hidden}.chartTop{display:flex;justify-content:space-between;font-size:10px;color:var(--muted)}.bars{height:75px;display:flex;align-items:end;gap:10px;margin-top:8px}.bar{flex:1;background:#9ee2c6;border-radius:5px 5px 2px 2px}.bar:nth-child(1){height:25%}.bar:nth-child(2){height:39%}.bar:nth-child(3){height:31%}.bar:nth-child(4){height:54%}.bar:nth-child(5){height:46%}.bar:nth-child(6){height:70%}.bar:nth-child(7){height:88%}.bar:nth-child(8){height:100%;background:var(--g)}.orders{margin-top:9px;border:1px solid var(--line);border-radius:11px;overflow:hidden}.order{display:flex;justify-content:space-between;padding:10px 11px;border-bottom:1px solid var(--line);font-size:10px}.order:last-child{border:0}.order span{color:var(--muted)}.done{color:var(--g2);font-weight:900}.float{position:absolute;background:#fff;color:var(--ink);border-radius:13px;padding:12px 14px;box-shadow:0 15px 35px #0004;border:1px solid #e8efec;z-index:3}.float b{display:block;font-size:12px}.float span{font-size:9px;color:var(--muted)}.f1{right:0;top:42px}.f2{left:0;bottom:52px}.f2 b{color:var(--g2)}.orb{position:absolute;width:350px;height:350px;border-radius:50%;background:#13c98720;filter:blur(14px)}
.section{padding:45px 0}.head{text-align:center;margin-bottom:23px}.head h2{font-size:29px;margin:0}.head p{color:var(--muted);margin:7px 0 0;font-size:14px}
.steps{display:grid;grid-template-columns:repeat(4,1fr);gap:13px}.step{background:#fff;border:1px solid var(--line);border-radius:17px;padding:22px;text-align:center}.num{width:40px;height:40px;border-radius:12px;background:var(--mint);color:var(--g2);display:flex;align-items:center;justify-content:center;margin:auto;font-weight:900}.step h3{font-size:15px;margin:12px 0 6px}.step p{color:var(--muted);font-size:12px;line-height:1.7;margin:0}
.section.alt{background:#fff}.featureGrid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.feature{border-radius:21px;padding:29px;min-height:260px}.products{background:#062f2c;color:#fff}.products p{color:#c3d9d4}.products .list{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:18px}.mini{background:#0a403b;border:1px solid #195a52;border-radius:10px;padding:10px;font-size:11px}.mini b{display:block;margin-bottom:3px}.mini span{color:#b9d2ce;font-size:9px}.profit{background:var(--mint);border:1px solid #d6eee3}.profit p{color:#4d6a60}.money{display:flex;align-items:end;gap:7px;margin:20px 0 12px}.money b{font-size:35px;color:var(--g2)}.money span{color:var(--muted);font-size:11px;padding-bottom:7px}.note{font-size:11px;color:var(--muted)}
.tools{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.tool{background:#fff;border:1px solid var(--line);border-radius:16px;padding:19px}.tool i{font-style:normal;font-size:25px}.tool b{display:block;margin:10px 0 5px;font-size:14px}.tool span{font-size:11px;color:var(--muted);line-height:1.6}
.cta{background:linear-gradient(105deg,#06332f,#0a765b);color:#fff;border-radius:23px;padding:36px;display:flex;align-items:center;justify-content:space-between;gap:25px}.cta h2{font-size:30px;margin:0 0 8px}.cta p{color:#c5ddd8;margin:0}.cta .l{background:#fff;color:#06352f;white-space:nowrap}
.footer{background:#fff;padding:28px 0}.foot{display:flex;justify-content:space-between;color:#74817e;font-size:12px}.footLinks{display:flex;gap:18px}.footLinks a:hover{color:var(--g2)}
@media(max-width:980px){.links{display:none}.heroIn{grid-template-columns:1fr}.dashboard{min-height:420px}.steps,.tools{grid-template-columns:repeat(2,1fr)}}
@media(max-width:600px){.top{display:none}.navIn{height:67px}.actions .l{display:none}.brand{font-size:19px}.copy{padding:35px 0 5px}.copy h1{font-size:39px}.dashboard{min-height:370px}.dashCard{width:100%;max-width:370px}.float{padding:9px}.f1{right:0;top:18px}.f2{left:0;bottom:35px}.stats{gap:5px}.stat{padding:9px}.stat b{font-size:13px}.featureGrid,.steps,.tools{grid-template-columns:1fr}.cta{flex-direction:column;align-items:flex-start}.foot{flex-direction:column;gap:15px}}
</style>
</head>
<body>

<div class="top"><div class="wrap topIn"><div><span>🚀 ابدأ بدون مخزون</span><span>اختر المنتج ونحن ننفذ الطلب</span></div><div><span>دعم المسوقين</span><span>تتبع الأرباح</span></div></div></div>
<header class="nav"><div class="wrap navIn">
<a class="brand" href="/"><span class="mark">SC</span><span>Syria Commerce<small>SELL • MARKET • EARN</small></span></a>
...
<div class="actions"><a class="btn l" href="/login">تسجيل الدخول</a><a class="btn g" href="/register">ابدأ الآن مجاناً ↗</a></div>
</div></header>

<main>
<section class="hero"><div class="wrap heroIn">
<div class="copy">
<span class="eyebrow">✦ منصة التسويق والبيع للمسوّقين</span>
<h1>سوّق المنتجات.<br><strong>بع أكثر. واربح.</strong></h1>
<p>لا تحتاج مستودع، ولا رأس مال كبير. اختر المنتجات من المنصة، سوّقها لجمهورك، ونحن نتولى معالجة الطلب والتوصيل.</p>
<div class="heroBtns"><a class="btn g" href="/register">🚀 ابدأ كمسوّق</a><a class="btn l" href="/products">تصفح المنتجات</a></div>
<div class="micro"><span>بدون مخزون</span><span>منتجات جاهزة للتسويق</span><span>متابعة أرباحك</span></div>
</div>
<div class="dashboard"><div class="orb"></div>
<div class="float f1"><b>💰 أرباحك تنمو</b><span>تابع نتائجك من لوحة المسوّق</span></div>
<div class="float f2"><b>✓ طلب جديد</b><span>تم تسجيل طلب من رابطك</span></div>
<div class="dashCard"><div class="dashHead"><b>لوحة المسوّق</b><div class="profile"><span>مسوّق نشط</span><span class="avatar">SC</span></div></div>
<div class="stats"><div class="stat"><small>أرباح الشهر</small><b class="greenText">1,840,000</b></div><div class="stat"><small>الطلبات</small><b>86</b></div><div class="stat"><small>المبيعات</small><b>12.4M</b></div></div>
<div class="chart"><div class="chartTop"><span>أداء المبيعات</span><span class="greenText">+28.4%</span></div><div class="bars"><i class="bar"></i><i class="bar"></i><i class="bar"></i><i class="bar"></i><i class="bar"></i><i class="bar"></i><i class="bar"></i><i class="bar"></i></div></div>
<div class="orders"><div class="order"><b>طلب #SC-1842</b><span class="done">تم التأكيد ✓</span></div><div class="order"><b>طلب #SC-1839</b><span class="done">تم الشحن ✓</span></div></div>
</div></div>
</div></section>

<section class="section"><div class="wrap"><div class="head"><h2>كيف تبدأ وتحقق أول عملية بيع؟</h2><p>كل شيء مصمم حتى تبدأ بسرعة وبدون تعقيد</p></div>
<div class="steps"><div class="step"><div class="num">1</div><h3>أنشئ حسابك</h3><p>سجّل كمسوّق وابدأ من حسابك مباشرة.</p></div><div class="step"><div class="num">2</div><h3>اختر منتجاً</h3><p>تصفح المنتجات واعرف سعر البيع وربحك قبل التسويق.</p></div><div class="step"><div class="num">3</div><h3>سوّق</h3><p>شارك الرابط والمحتوى عبر قنواتك وجمهورك.</p></div><div class="step"><div class="num">4</div><h3>اربح</h3><p>عندما ينجح الطلب، تحصل على ربحك وتتابعه من حسابك.</p></div></div></div></section>

<section class="section alt"><div class="wrap"><div class="head"><h2>كل ما يحتاجه المسوّق في مكان واحد</h2><p>أدوات تساعدك تختار وتسوّق وتتابع</p></div>
<div class="tools"><div class="tool"><i>🛍️</i><b>منتجات جاهزة</b><span>كتالوج منتجات يمكنك اختيار ما يناسب جمهورك.</span></div><div class="tool"><i>📸</i><b>محتوى تسويقي</b><span>صور ومعلومات تساعدك في نشر المنتج بسرعة.</span></div><div class="tool"><i>🔗</i><b>روابط التسويق</b><span>شارك منتجاتك وتتبع الطلبات القادمة منك.</span></div><div class="tool"><i>📊</i><b>تقارير وأرباح</b><span>تابع المبيعات والطلبات والأرباح من حسابك.</span></div></div></div></section>

<section class="section"><div class="wrap"><div class="featureGrid">
<div class="feature products"><h2>🔥 منتجات تستحق التسويق</h2><p>اكتشف المنتجات التي يمكنك البدء بتسويقها الآن.</p><div class="list"><div class="mini"><b>سماعة لاسلكية</b><span>ربح متوقع: 45,000 SYP</span></div><div class="mini"><b>ساعة رجالية</b><span>ربح متوقع: 80,000 SYP</span></div><div class="mini"><b>عطر أصلي</b><span>ربح متوقع: 65,000 SYP</span></div><div class="mini"><b>حقيبة عملية</b><span>ربح متوقع: 38,000 SYP</span></div></div><a class="btn g" href="/products" style="margin-top:17px">شاهد المنتجات</a></div>
<div class="feature profit"><h2>💰 اعرف ربحك قبل أن تبدأ</h2><p>شفافية كاملة في أسعار المنتجات والربح المتوقع لكل عملية بيع.</p><div class="money"><b>45,000</b><span>SYP / عملية بيع</span></div><div class="note">مثال توضيحي — الربح الفعلي يختلف حسب المنتج وشروطه.</div><a class="btn d" href="/register" style="margin-top:19px">ابدأ حسابك</a></div>
</div></div></section>

<section class="section" style="padding-top:4px"><div class="wrap"><div class="cta"><div><h2>جاهز تبدأ أول عملية بيع؟</h2><p>أنشئ حسابك كمسوّق وابدأ باختيار أول منتج لك.</p></div><a class="btn l" href="/register">ابدأ الآن مجاناً ↗</a></div></div></section>
</main>

<footer class="footer"><div class="wrap foot"><div>© 2026 Syria Commerce — منصة التسويق والبيع</div><div class="footLinks"><a href="/products">المنتجات</a><a href="/marketer">المسوّق</a><a href="/login">تسجيل الدخول</a><a href="/register">التسجيل</a></div></div></footer>
