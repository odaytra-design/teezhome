...
<style>
:root{--ink:#171717;--muted:#747474;--paper:#faf9f6;--white:#fff;--line:#e7e4de;--dark:#171717;--soft:#f1efea;--accent:#e8e2d8}
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--paper);color:var(--ink);font-family:Arial,Tahoma,sans-serif;-webkit-font-smoothing:antialiased}
a{text-decoration:none;color:inherit}.wrap{max-width:1220px;margin:auto;padding:0 30px}
.nav{height:78px;border-bottom:1px solid var(--line);display:flex;align-items:center;background:var(--paper)}.navIn{width:100%;display:flex;align-items:center;gap:38px}.logo{font-weight:950;font-size:20px;letter-spacing:-.8px;white-space:nowrap}.logo b{font-weight:950}.logo small{display:block;color:#92908a;font-size:6px;letter-spacing:2px;margin-top:3px}.links{display:flex;gap:25px;flex:1}.links a{font-size:11px;color:#5e5e5e;font-weight:800}.links a:hover{color:#111}.actions{display:flex;gap:8px}.btn{display:inline-flex;align-items:center;justify-content:center;border:1px solid #cfcac2;border-radius:8px;padding:11px 18px;font-size:11px;font-weight:900}.btn.dark{background:#171717;color:#fff;border-color:#171717}.btn.light{background:#fff}
.hero{padding:80px 0 90px;background:#f3f1ec}.heroIn{display:grid;grid-template-columns:1.08fr .92fr;gap:65px;align-items:center}.eyebrow{font-size:9px;text-transform:uppercase;letter-spacing:1.5px;color:#77736c;font-weight:900}.hero h1{font-size:clamp(48px,6.2vw,78px);line-height:1.02;letter-spacing:-4px;margin:20px 0 25px;font-weight:950}.hero h1 span{display:block}.hero p{font-size:17px;line-height:1.95;color:#66635e;max-width:600px;margin:0}.heroBtns{display:flex;gap:9px;margin-top:29px}.heroBtns .btn{padding:14px 23px}.micro{font-size:9px;color:#8a8882;margin-top:15px}
.heroVisual{height:505px;position:relative;display:flex;align-items:center;justify-content:center}.heroPhoto{width:430px;height:430px;background:#dedbd3;position:relative;overflow:hidden;border-radius:2px}.heroPhoto:before{content:"";position:absolute;width:330px;height:330px;background:#c9c4ba;border-radius:50%;top:35px;left:50%;transform:translateX(-50%)}.heroPhone{position:absolute;width:220px;height:405px;background:#fff;border:8px solid #1d1d1d;border-radius:29px;right:95px;top:35px;box-shadow:0 24px 55px #0002;overflow:hidden}.phoneHead{height:48px;background:#1d1d1d;color:#fff;padding:0 13px;display:flex;justify-content:space-between;align-items:center;font-size:8px}.phoneBody{padding:18px}.phoneBody small{font-size:8px;color:#888}.amount{font-size:28px;font-weight:950;margin:7px 0 18px}.pLine{height:8px;background:#e9e6df;border-radius:5px;margin:9px 0}.pLine.short{width:58%}.pBox{border:1px solid #e1ded7;border-radius:9px;padding:10px;margin-top:13px;font-size:8px;display:flex;justify-content:space-between}.heroLabel{position:absolute;left:10px;bottom:28px;background:#fff;padding:13px 15px;box-shadow:0 12px 35px #0001;font-size:9px}.heroLabel b{display:block;font-size:16px;margin-top:3px}.heroSide{position:absolute;right:8px;bottom:18px;background:#1d1d1d;color:#fff;padding:12px 15px;font-size:8px}.heroSide strong{font-size:14px;display:block;margin-top:3px}
.numbers{background:#1d1d1d;color:#fff}.numbersIn{height:90px;display:flex;align-items:center;justify-content:space-between}.numbersText{font-size:10px;color:#bbb8b1}.stats{display:flex;gap:55px}.stats b{font-size:18px}.stats span{font-size:8px;color:#a7a49e;margin-right:4px}
.section{padding:95px 0}.head{max-width:700px;margin-bottom:50px}.head h2{font-size:43px;line-height:1.15;letter-spacing:-2px;margin:10px 0 13px}.head p{font-size:14px;line-height:1.9;color:var(--muted);margin:0}
.feature{display:grid;grid-template-columns:1fr 1fr;gap:90px;align-items:center;margin:75px 0}.feature.reverse{direction:ltr}.feature.reverse>*{direction:rtl}.featureCopy h3{font-size:31px;letter-spacing:-1px;margin:8px 0 14px}.featureCopy p{font-size:14px;color:#6e6b65;line-height:2;margin:0;max-width:510px}.num{font-size:9px;letter-spacing:1px;color:#8a867e;font-weight:900}.featureArt{height:330px;background:#ebe8e1;position:relative;overflow:hidden}.featureArt:before{content:"";position:absolute;width:260px;height:260px;border-radius:50%;background:#d7d2c8;top:35px;left:50%;transform:translateX(-50%)}.window{position:absolute;width:285px;height:190px;background:#fff;top:74px;left:50%;transform:translateX(-50%);padding:22px;box-shadow:0 18px 40px #0001}.windowTop{display:flex;justify-content:space-between;font-size:8px;border-bottom:1px solid #e5e2dc;padding-bottom:12px}.windowValue{font-size:24px;font-weight:950;margin:15px 0}.wline{height:7px;background:#e8e5df;margin:9px 0}.wline.short{width:52%}.featureTag{position:absolute;background:#fff;padding:10px 13px;font-size:8px;box-shadow:0 10px 25px #0001}.ft1{right:25px;top:42px}.ft2{left:24px;bottom:35px;background:#1d1d1d;color:#fff}
.productSection{background:#fff}.products{display:grid;grid-template-columns:repeat(4,1fr);gap:20px}.product{border-bottom:1px solid #ddd9d1;padding-bottom:17px}.prodImg{height:245px;background:#eeeae2;display:grid;place-items:center;font-size:65px}.product h4{font-size:14px;margin:14px 0 5px}.product p{font-size:9px;color:#85827c;margin:0}.product strong{display:block;font-size:11px;margin-top:11px}
.how{background:#f3f1ec}.steps{display:grid;grid-template-columns:repeat(3,1fr);gap:55px}.step{border-top:1px solid #252525;padding-top:18px}.stepNo{font-size:9px;color:#8a867e}.step h3{font-size:19px;margin:12px 0 7px}.step p{font-size:11px;color:#73716c;line-height:1.9;margin:0}
.statement{padding:105px 0;background:#1d1d1d;color:#fff;text-align:center}.statement h2{font-size:43px;line-height:1.35;letter-spacing:-1.5px;margin:0 auto;max-width:820px}.statement p{font-size:10px;color:#a8a49c;margin-top:18px}
.cta{padding:80px 0}.ctaBox{background:#e8e3da;padding:43px 50px;display:flex;justify-content:space-between;align-items:center}.ctaBox h2{font-size:32px;margin:0 0 6px}.ctaBox p{font-size:10px;color:#716e68;margin:0}
footer{border-top:1px solid var(--line);padding:28px 0;background:#fff}.foot{display:flex;justify-content:space-between;color:#85827c;font-size:8px}
@media(max-width:900px){.links{display:none}.heroIn,.feature{grid-template-columns:1fr;gap:35px}.heroVisual{height:450px}.products{grid-template-columns:repeat(2,1fr)}.steps{grid-template-columns:1fr;gap:30px}.numbersIn{height:auto;padding:22px 30px;display:block}.stats{margin-top:13px;gap:28px}.feature.reverse{direction:rtl}.section{padding:70px 0}}
@media(max-width:600px){.wrap{padding:0 18px}.nav{height:68px}.actions .light{display:none}.hero{padding:52px 0 58px}.hero h1{font-size:46px;letter-spacing:-2.5px}.hero p{font-size:14px}.heroVisual{height:370px}.heroPhoto{width:300px;height:300px}.heroPhone{width:180px;height:330px;right:55px;top:18px}.phoneBody{padding:12px}.amount{font-size:22px}.heroLabel{left:0;bottom:18px}.heroSide{right:0;bottom:8px}.stats{gap:17px}.stats b{font-size:15px}.head h2{font-size:31px}.featureCopy h3{font-size:27px}.featureArt{height:275px}.window{width:235px;height:160px;top:65px;padding:17px}.products{gap:14px}.prodImg{height:170px;font-size:48px}.product h4{font-size:12px}.statement{padding:70px 0}.statement h2{font-size:28px}.ctaBox{padding:30px 24px;display:block}.ctaBox .btn{display:inline-flex;margin-top:20px}}
</style>
</head>
<body>
<header><div class="wrap navIn nav">
<a class="logo" href="/"><b>SYRIA COMMERCE</b><small>COMMERCE FOR MARKETERS</small></a>
<nav class="links"><a href="/">الرئيسية</a><a href="/products">المنتجات</a><a href="/marketer">للمسوّقين</a><a href="/marketer">كيف تعمل؟</a><a href="/login">حسابي</a></nav>
<div class="actions"><a class="btn light" href="/login">دخول</a><a class="btn dark" href="/register">ابدأ الآن</a></div>
</div></header>

<section class="hero"><div class="wrap heroIn">
<div><div class="eyebrow">منصة تجارة للمسوّقين</div><h1>حوّل جمهورك<br><span>إلى مبيعات.</span></h1><p>كل ما تحتاجه لتبدأ البيع من دون مخزون أو متجر خاص: منتجات جاهزة، أدوات تسويق، إدارة للطلبات، وتتبع واضح لأرباحك.</p><div class="heroBtns"><a class="btn dark" href="/register">ابدأ كمسوّق مجانًا ↗</a><a class="btn light" href="/products">استكشف المنتجات</a></div><div class="micro">حساب مجاني • لا تحتاج إلى مخزون • ابدأ متى ما أردت</div></div>
<div class="heroVisual"><div class="heroPhoto"><div class="heroPhone"><div class="phoneHead"><span>SYRIA COMMERCE</span><span>مسوّق</span></div><div class="phoneBody"><small>أرباحك هذا الشهر</small><div class="amount">1,840 JD</div><div class="pLine"></div><div class="pLine short"></div><div class="pBox"><span>طلبات مكتملة</span><b>86</b></div><div class="pBox"><span>طلبات جديدة</span><b>11</b></div><div class="pBox"><span>منتجات نشطة</span><b>38</b></div></div></div></div><div class="heroLabel"><small>عمولة متاحة</small><b>+ 420 JD</b></div><div class="heroSide"><span>هذا الأسبوع</span><strong>+28.4%</strong></div></div>
</div></section>

<section class="numbers"><div class="wrap numbersIn"><div class="numbersText">منصة واحدة، وكل ما يحتاجه المسوّق في مكان واحد.</div><div class="stats"><div><b>+1,200</b><span>مسوّق</span></div><div><b>+8,500</b><span>طلب</span></div><div><b>+320</b><span>منتج</span></div></div></div></section>

<section class="section" id="why"><div class="wrap"><div class="head"><div class="eyebrow">كل شيء يبدأ من المنتج</div><h2>اختر ما يناسب جمهورك، والباقي نمشيه معك.</h2><p>ما بدنا منك تكون تاجر جملة ومخزن وموظف متابعة بنفس الوقت. دورك الأساسي هو التسويق والبيع.</p></div>
<div class="feature"><div class="featureCopy"><div class="num">01 / المنتجات</div><h3>منتجات جاهزة لتبدأ تسويقها</h3><p>شاهد المنتج، سعره، وهامش ربحك قبل أن تنشره. اختَر المنتجات التي تشبه جمهورك بدل ما تشتري مخزون وتنتظر.</p></div><div class="featureArt"><div class="window"><div class="windowTop"><span>تفاصيل المنتج</span><span>متاح</span></div><div class="windowValue">45 JD</div><div class="wline"></div><div class="wline short"></div><div class="wline"></div></div><span class="featureTag ft1">هامش ربح واضح</span><span class="featureTag ft2">جاهز للتسويق</span></div></div>
<div class="feature reverse"><div class="featureCopy"><div class="num">02 / الطلبات</div><h3>من أول نقرة إلى إتمام الطلب</h3><p>لما يجي طلب من رابطك، يصير له مسار واضح. تقدر تعرف وين وصل الطلب بدون مطاردة الرسائل أو الجداول.</p></div><div class="featureArt"><div class="window"><div class="windowTop"><span>حالة الطلب</span><span>#SC-1842</span></div><div class="windowValue">تم التأكيد ✓</div><div class="wline"></div><div class="wline short"></div><div class="wline"></div></div><span class="featureTag ft1">قيد التجهيز</span><span class="featureTag ft2">تتبع واضح</span></div></div>
<div class="feature"><div class="featureCopy"><div class="num">03 / الأرباح</div><h3>اعرف ربحك، بدون تخمين</h3><p>كل عملية بيع مرتبطة بحسابك. تابع العمولة والمبيعات والطلبات المكتملة من مكان واحد وبصورة مفهومة.</p></div><div class="featureArt"><div class="window"><div class="windowTop"><span>الأرباح</span><span>هذا الشهر</span></div><div class="windowValue">1,840 JD</div><div class="wline"></div><div class="wline"></div><div class="wline short"></div></div><span class="featureTag ft1">+ 420 JD</span><span class="featureTag ft2">مستحقاتك</span></div></div>
</div></section>

<section class="section productSection" id="products"><div class="wrap"><div class="head"><div class="eyebrow">المنتجات</div><h2>ابدأ من منتج تعرف كيف تبيعه.</h2><p>مجموعة من المنتجات المتاحة للمسوّقين، مع معلومات واضحة تساعدك على الاختيار.</p></div>
<div class="products"><article class="product"><div class="prodImg">⌚</div><h4>ساعات وإكسسوارات</h4><p>طلب مستمر · جمهور واسع</p><strong>عمولة تصل إلى 12 JD</strong></article><article class="product"><div class="prodImg">🎧</div><h4>إلكترونيات</h4><p>مناسبة للمحتوى والإعلانات</p><strong>عمولة تصل إلى 18 JD</strong></article><article class="product"><div class="prodImg">👜</div><h4>إكسسوارات نسائية</h4><p>منتجات خفيفة وسهلة الشحن</p><strong>عمولة تصل إلى 9 JD</strong></article><article class="product"><div class="prodImg">🏠</div><h4>منتجات منزلية</h4><p>احتياج يومي · حركة جيدة</p><strong>عمولة تصل إلى 11 JD</strong></article></div></div></section>

<section class="section how" id="how"><div class="wrap"><div class="head"><div class="eyebrow">كيف تبدأ؟</div><h2>ثلاث خطوات، بدون تعقيد.</h2></div><div class="steps"><div class="step"><div class="stepNo">01</div><h3>أنشئ حسابك</h3><p>سجّل كمسوّق وأنشئ مساحتك خلال دقائق.</p></div><div class="step"><div class="stepNo">02</div><h3>اختر وسوّق</h3><p>اختَر المنتج المناسب وشاركه مع جمهورك بالطريقة التي تعرفها.</p></div><div class="step"><div class="stepNo">03</div><h3>بع واربح</h3><p>تابع الطلب والعمولة والنتيجة من حسابك.</p></div></div></div></section>

<section class="statement"><div class="wrap"><h2>أنت تعرف كيف تصل للناس.<br>نحن نرتّب لك ما يأتي <span style="color:#c8c1b5">بعد ذلك.</span></h2><p>Syria Commerce — منصة تجارة صُممت للمسوّق.</p></div></section>

<section class="cta"><div class="wrap"><div class="ctaBox"><div><h2>عندك جمهور؟ خلّيه مصدر دخلك.</h2><p>ابدأ مجانًا واستكشف أول المنتجات التي يمكنك تسويقها.</p></div><a class="btn dark" href="/register">أنشئ حساب مسوّق ↗</a></div></div></section>

<footer><div class="wrap foot"><span>© 2026 Syria Commerce</span><span>منصة تجارة للمسوّقين</span></div></footer>
